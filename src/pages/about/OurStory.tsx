        ...
        <main className="w-full lg:w-[70vw] lg:ml-auto px-6">
          ...
          <ContentSection>
            <ImageTextBlock
              ...
              content="Ahia was born from a shared vision of creating timeless pieces that transcend fleeting trends. Our founders, united by their passion for exceptional craftsmanship and sustainable practices, established the brand with a commitment to creating modern heritage designs that tell a story - your story."
              imagePosition="left"
            />
          </ContentSection>
